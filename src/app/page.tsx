  ...
  return (
    <div className="bg-[#050505] text-white antialiased overflow-x-hidden min-h-screen font-sans">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[800px] h-[800px] bg-[#004225]/5 blur-[120px] rounded-full animate-pulse" />
        <div className="absolute bottom-[0%] right-[-5%] w-[600px] h-[600px] bg-[#002366]/5 blur-[120px] rounded-full" />
      </div>
      ...
      <nav className="fixed top-0 w-full z-50 px-8 py-6 flex justify-between items-center bg-[#050505]/60 backdrop-blur-md border-b border-white/5">
        ...
        <div className="hidden md:flex gap-12 items-center">
          {['Global Talent', 'Portfolio', 'Intelligence', 'Pricing'].map((item) => (
            <a key={item} href={`#${item.toLowerCase()}`} className="text-[10px] uppercase tracking-[0.4em] font-bold text-zinc-500 hover:text-white transition-colors">
              {item}
            </a>
          ))}
        </div>
        <button className="px-6 py-2 bg-[#004225] text-white text-[10px] font-bold uppercase tracking-widest rounded-full hover:bg-[#002366] transition-all duration-700">
          Get Started
        </button>
      </nav>
      ...
      <main className="relative z-10">
        ...
        <section className="h-screen flex flex-col items-center justify-center text-center px-6 pt-20">
          ...
          >
            ...
            <p className="text-zinc-500 text-lg md:text-xl max-w-2xl mx-auto mb-16 leading-relaxed font-light">
              Strategic portfolio architecture, PR positioning, and AI intelligence for the world's most ambitious professionals entering the UK.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-12">
              <button className="px-14 py-5 bg-[#004225] text-white text-[10px] font-bold uppercase tracking-[0.3em] rounded-full hover:bg-[#002366] transition-all duration-1000 shadow-[0_0_50px_rgba(0,66,37,0.15)]">
                Start Consultation
              </button>
        ...
        <section className="py-40 px-8 border-y border-white/5 bg-zinc-950/20">
          <div className="max-w-7xl mx-auto">
             <h2 className="text-[10px] font-bold uppercase tracking-[0.5em] text-zinc-700 mb-24 text-center">Core Pillars</h2>
        ...
        <section id="intelligence" className="py-40 px-8">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="relative bg-zinc-950/50 rounded-3xl p-10 overflow-hidden border border-white/5 backdrop-blur-xl">
              <div className="absolute top-0 right-0 p-4 font-mono text-[8px] text-zinc-800">GT_SECURE_MODE_v1.0</div>
              <div className="flex items-center gap-4 mb-10 border-b border-white/5 pb-6">
                <Activity className="w-4 h-4 text-[#004225] animate-pulse" />
                <span className="text-[10px] font-bold uppercase tracking-widest">Live Monitoring Stream</span>
              </div>
              <div className="space-y-6">
                {[
                  { wallet: "0x89...ENTRY", action: "BOUGHT $SOL-AI", trend: "High Confidence", color: "text-[#004225]" },
                  { wallet: "Founder_Alpha", action: "EXITED $MEME", trend: "Strategic Exit", color: "text-[#002366]" },
                  { wallet: "VC_Whale_01", action: "MONITORING $AGI", trend: "Narrative Spike", color: "text-[#004225]" },
                ].map((log, i) => (
                  <div key={i} className="flex justify-between items-center text-[11px] font-mono border-b border-white/5 pb-4 last:border-0">
                    <span className="text-zinc-500 text-left">{log.wallet}</span>
        ...
        <section id="pricing" className="py-40 px-8 border-t border-white/5">
           <div className="max-w-7xl mx-auto">
              <div className="text-center mb-24">
                <h2 className="text-5xl font-serif italic mb-6">Invest in the Future.</h2>
                ...
                {[
                  ...
                  <div key={i} className={`p-12 border ${plan.popular ? 'border-[#004225] bg-[#004225]/5' : 'border-white/5'} hover:border-[#002366] transition-all duration-700 flex flex-col justify-between`}>
                    <div>
                      ...
                      <div className="text-5xl font-medium mb-12">{plan.price}<span className="text-xs text-zinc-700">/mo</span></div>
                    ...
                    <button className={`w-full py-4 text-[10px] font-bold uppercase tracking-widest rounded-full transition-all ${plan.popular ? 'bg-[#004225] text-white' : 'border border-zinc-800 text-zinc-500 hover:text-white'}`}>
                      Access Now
                    </button>
                  </div>
                ))}
      ...
      <footer className="py-24 border-t border-white/5 text-center">
        ...
        <p className="text-[9px] text-zinc-800 uppercase tracking-[0.5em]">
