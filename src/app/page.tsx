...
import { ArrowUpRight, ShieldCheck, Globe, Zap, Check } from "lucide-react";
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 px-6 md:px-12 py-6 flex justify-between items-center bg-[#050505]/80 backdrop-blur-xl border-b border-white/10">
        ...
        <button className="px-5 py-2 bg-white text-black text-[10px] font-bold uppercase tracking-widest rounded-full hover:bg-[#004225] hover:text-white transition-all duration-500">
          Connect
        </button>
      </nav>
        ...
        <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20">
          ...
          >
            <div className="mb-8 flex items-center justify-center gap-3">
              ...
              <span className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] font-bold text-zinc-400">
                London • Singapore • Global
              </span>
              <span className="w-6 h-[1px] bg-[#002366]" />
            </div>
            
            {/* 这里的 text-4xl (手机) 到 text-[100px] (电脑) 保证了同步感 */}
            ...
            <p className="text-zinc-400 text-sm md:text-lg max-w-xl mx-auto mb-12 leading-relaxed px-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-10">
              ...
              <button className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 hover:text-white flex items-center gap-2 transition-all">
