  ...
  return (
    <div className="bg-[#050505] text-white antialiased overflow-x-hidden min-h-screen font-sans">
      ...
      <main className="relative z-10">
        ...
        <section className="h-screen flex flex-col items-center justify-center text-center px-6 pt-20">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2 }}>
            ...
            <button className="px-12 py-4 bg-[#004225] text-white text-[10px] font-bold uppercase tracking-widest rounded-full hover:shadow-[0_0_30px_rgba(0,66,37,0.4)] transition-all">
              Start Consultation
            </button>
          </motion.div>
        </section>
        ...
        <section id="pricing" className="py-40 px-6 border-t border-white/10 bg-black/40">
           <div className="max-w-7xl mx-auto">
              <div className="text-center mb-24">
                ...
                <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-[0.4em]">Direct USDC (Solana) & Card Payments.</p>
              </div>
                ...
                {[
                  ...
                  <div key={i} className={`p-10 border ${plan.popular ? 'border-[#004225] bg-[#004225]/5' : 'border-white/5'} flex flex-col justify-between hover:bg-zinc-900/50 transition-all group`}>
                    ...
                    <div className="space-y-4">
                      <button className={`w-full py-4 text-[10px] font-bold uppercase tracking-widest rounded-full transition-all ${plan.popular ? 'bg-white text-black hover:bg-zinc-200' : 'border border-zinc-800 text-zinc-400 hover:text-white'}`}>
                        Access with Card
                      </button>
                      <button 
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            >
              ...
              <div className="mb-8">
                ...
                <p className="text-xs text-zinc-500 uppercase tracking-widest">Plan: {selectedPlan.name} • {selectedPlan.price}</p>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-zinc-900/50 p-6 rounded-2xl border border-white/5 space-y-4">
                  <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-widest text-zinc-500">
                    <span>Network</span>
                    <span className="text-white flex items-center gap-2"><div className="w-2 h-2 bg-[#004225] rounded-full" /> Solana</span>
                  </div>
                  <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-widest text-zinc-500">
                    <span>Asset</span>
                    <span className="text-white font-mono uppercase tracking-tighter">USDC (SPL)</span>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1 bg-[#050505] p-4 rounded-xl border border-white/5 text-[10px] font-mono break-all text-zinc-300">
                      {walletAddress}
                    </div>
                    <button 
                      onClick={copyAddress}
                ...
                <div className="p-6 bg-white/[0.02] border border-dashed border-white/10 rounded-2xl text-center">
                  <p className="text-[10px] text-zinc-500 uppercase leading-relaxed">
                    Please send the exact amount to the address above. <br /> After payment, contact our concierge via Telegram with your transaction hash.
                  </p>
                </div>

                <button className="w-full py-4 bg-zinc-800 text-white text-[10px] font-bold uppercase tracking-widest rounded-full flex items-center justify-center gap-3 hover:bg-zinc-700 transition-all">
                  <Smartphone className="w-4 h-4" /> Open in Phantom / Solflare
                </button>
              </div>
            </motion.div>
          </div>
      ...
      <footer className="py-20 border-t border-white/10 text-center px-6">
        <div className="text-xl font-bold tracking-[0.2em] mb-8 uppercase text-white">GEATALENT</div>
        <p className="text-zinc-500 text-[10px] uppercase tracking-[0.4em]">© 2024 GEATALENT COPYRIGHT</p>
      </footer>
    </div>
  );
}
